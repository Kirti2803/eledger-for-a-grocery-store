...
?>
 ...
 <body>
  ...
  <div align="center">
   ...
   <div style="font-size:35px; font-style:bolder;padding-bottom:20px;padding-top:20px;">
 <span style="color:#620382";><u><b>Invoice</u></b></span>
   </div>
  <table style="float:left;margin-left:30px; ">
   <tr>
	...
	<tr>
    <td><b>Adhaar </b></td><td><?php echo $cos_village;?></td>
   </tr>
   </table>
  ...
  <td><input type="submit" name="insert" value="Add" style="color:#fff;background: #7a0e9e;"/></td>
  </form>
  </tr>
